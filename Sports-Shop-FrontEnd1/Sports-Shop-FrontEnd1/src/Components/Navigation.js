...
const Navigation = (props) => {
  ...
  return (
    <div>
      <nav className="navbar navbar-expand-lg navbar-dark bg-primary myNav text-light" style={{height:'10vh'}}>
        <div className="container-fluid">
          <Link className="navbar-brand" to="/">Sportify <i class="bi bi-xbox"></i></Link>
          ...
          {!userSignIn.response && (
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                <li className="nav-item">
                  <Link className="nav-link active" aria-current="page" to="/"> <i class="bi bi-house-door-fill"></i> </Link>
                </li>
                <li className="nav-item">
              ...
              <div className="d-flex">
                <Link to="/signin" className="btn btn-outline-info bg-light" type="button">Login <i class="bi bi-box-arrow-in-right"></i></Link>
              </div>
            </div>
          )}
        </div>
