...
const CustomerProductsScreen = (props) => {
    ...
    useEffect(()=>{
        if(!userSignIn && categories.length === 0){
                                    ...
                                    return(
                                        <div className="col-md-3 col-sm-6 col-xs-12 myCardElement">
                                            <div className="card">
                                                ...
                                                {
                                                    product.imageName &&
                                                    <img src={url_image + `/${product.imageName}`} alt="product" className="Image img-fluid productImage"/>
                                                }
                                                {
                                                    !product.imageName &&
                                                    <img src={AddProduct} alt="product" className="Image img-fluid productImage"/>
                                                }
