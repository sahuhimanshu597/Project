...
const getStatusClass = (status) => {
  ...
  return (
    ...
    <div className="Customer">
    <div className="Screen"style={{ backgroundImage:`url(${Customer})`,height:'100vh',marginTop:'5px',width:'182vh',backgroundSize: 'cover'}}>
      {
        !userSignIn.response && 
      ...
      userSignIn.response && 
        <div className="text" >
        <div className="text-light"><Header title={"Welcome " + userSignIn.response.data.firstName} /></div>
          <div className="row">
          {
