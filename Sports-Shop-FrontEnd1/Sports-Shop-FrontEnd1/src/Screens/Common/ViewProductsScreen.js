                                    ...
                                    <div className="card-body text-center">
                                        {
                                            ...
                                            <img src={url_image+`/${detail.product.imageName}`} alt="productimage" className="Image img-fluid productImage"/>
                                      
                                        }
                                        {
                                            detail.product.imageName===null &&
                                            <img src={AddProduct} alt="productimage" className="Image img-fluid"/>
                                        }
